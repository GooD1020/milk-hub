...
local function loading()
	...
	Logo.Image = "rbxassetid://9988838959"
	...
	BAR1.Name = "BAR1"
	BAR1.Parent = Bar
	BAR1.BackgroundColor3 = Color3.fromRGB(0,255,0)
...
if string.lower(game:GetService("RbxAnalyticsService"):GetClientId()) == game:GetService("RbxAnalyticsService"):GetClientId() then
    ...
    ImageButton.Image = "rbxassetid://9988838959"
...
local Star = nill:Window("Free GUI")

local StarServer = Star:Server("MIKIHUB",8521503225)


--Manu

local AutoFarm = StarServer:Channel("ฟาม")
local S = StarServer:Channel("ตั้งค่า")
local Main = StarServer:Channel("main ไม่รุ้")
local Stats = StarServer:Channel("อัพอัตโนมัติ")
local Island = StarServer:Channel("ย้ายเกาะ")
local Dungeon = StarServer:Channel("ลงดัน")
local Player = StarServer:Channel("ล่าค่าหัว")
--Manu

AutoFarm:Toggle("Auto SetSpawn Point",true,function(x)
    _G.Set = x
end)
...
AutoFarm:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
  ...
  AutoFarm:Line("MojoBoss")
    ...
    AutoFarm:Toggle("AutoMoJi",_G.AutoDoughtBoss,function(value)
    ...
    local SelectWeapons = AutoFarm:Dropdown("SelectWeapons",WeaponList,function(value)
        _G.SelectWeapon = value
    end)
    
    AutoFarm:Toggle("Refresh Weapon",function()
        SelectWeapons:Clear()
        for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do  
...
AutoFarm:Line("Mastery")
    
    AutoFarm:Toggle("Auto Farm BF Mastery",_G.AutoFarmFruitMastery,function(value)
    ...
    AutoFarm:Toggle("Auto Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
    ...
    --SFN
S:Toggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
    ...
    S:Toggle("FastAttack",true,function(value)
_G.FastAttack = value
end)
...
S:Toggle("FastAttack2",true,function(value)
...
S:Toggle("จอขาว",false,function(vu)
_G.WhiteScren = vu
end)
    ...
    S:Line("Mastery Skill Settings")
    
    S:Toggle("Skill Z",true,function(value)
        _G.SkillZ = value
    end)
    
    S:Toggle("Skill X",true,function(value)
        _G.SkillX = value
    end)
    
    S:Toggle("Skill C",true,function(value)
        _G.SkillC = value
    end)
    
    S:Toggle("Skill V",true,function(value)
        _G.SkillV = value
    end)
    ...
    Main:Toggle("ไม่อยุ่",_G.AutoAdvanceDungeon,function(value)
    ...
    Main:Line("หาดาบ bigmom")
    
    Main:Toggle("หาดาบ bigmom",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:Toggle("หาดาบ bigmomHop",_G.AutoBudySwordHop,function(value)
    ...
    Main:Line("à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸—")
    ...
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸—",_G.AutoElitehunter,function(value)
    ...
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸— à¸­à¸­à¸",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    Main:Line("à¹€à¸„à¸µà¸¢à¸§")
    
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰à¹€à¸„à¸µà¸¢à¸§",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰à¹€à¸„à¸µà¸¢à¸§ à¸­à¸­à¸",_G.AutoFarmBossHallowHop,function(value)
    ...
    Main:Line("หาโยรุเล็ก")
    
    Main:Toggle("หาโยรุเล็ก",_G.AutoDarkDagger,function(value)
    ...
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰à¸”à¸²à¸šà¸«à¸³à¸ˆà¸´à¹‹à¸§ Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    Main:Line("หา swanGlasses")
    
    Main:Toggle("หา swanGlasses",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:Toggle("หา swanGlasseshop”",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    Main:Line("Autofram_Bone")
    
    local BoneFarm = Main:Toggle("Autofram_Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main:Toggle("สุ่ม_Bone",_G.Auto_Random_Bone,function(value)
    ...
    Main:Toggle("autoทำฮาคิวี2",_G.AutoObservation,function(value)
    ...
    Main:Toggle("à¸­à¸­à¹‚à¸•à¹‰ à¸Ÿà¸²à¸£à¹Œà¸¡ à¸«à¸²à¸‚à¸µà¹ˆà¸ªà¸±à¸‡à¹€à¸à¸• à¸­à¸­à¸",_G.AutoObservation_Hop,function(value)
    ...
    Main:Toggle("หาดาบแชง",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    Main:Toggle("หาดาบแชงย้าย",_G.AutoSaber_Hop,function(value)
    ...
    Main:Toggle("หาดาบตำนานโลก2")
    
    Main:Toggle("หาดาบตำนานโลก2",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:Toggle("หาดาบตำนานแบบย้าย",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    Main:Line("Enchancement Colour")
    ...
    Main:Toggle("à¸—à¸³à¸”à¸²à¸š twoà¸Šà¸µà¹‰à¸•à¸°",_G.AutoHolyTorch,function(value)
    ...
    --State
    Stats:Label(" Stats FN")
    Stats:Toggle("อัพหมัด”", _G.Melee, function(vu)
        _G.Melee = vu
    end)
    Stats:Toggle("อัพเลือด", _G.Defense, function(vu)
        _G.Defense = vu
    end)
    Stats:Toggle("อัพดาบ", _G.Sword, function(vu)
        _G.Sword = vu
    end)
    Stats:Toggle("อัพปืน", _G.Gun, function(vu)
        _G.Gun = vu
    end)
    Stats:Toggle("อัพผล", _G.Fruit, function(vu)
        _G.Fruit = vu
    end)
    Stats:Label("Kaitan Stats")
    Stats:Toggle("Stats™Stats",false,function(vu)
        _G.Melee = vu
        _G.Defense = vu
    end)
    ...
    Dungeon:Toggle("ลงดันอัตโนมัติ",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:Toggle("ทำผลตื่น",_G.Auto_Awakener,function(value)
    ...
    Dungeon:Toggle("AutoSelectDungeon",_G.AutoSelectDungeon,function(value)
    ...
    Dungeon:Toggle("ชื้อชิป",_G.AutoBuyChip,function(value)
    ...
    Dungeon:Button("à¸‹à¸·à¹‰à¸­à¸Šà¸´à¸›",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dungeon:Toggle("ลงดันอัตโนมัติ",_G.Auto_StartRaid,function(value)
    ...
    Dungeon:Button("Dungeon",function()
        if New_World then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif Three_World then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Dungeon:Button("à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹€à¸à¸£à¸²à¸°",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
